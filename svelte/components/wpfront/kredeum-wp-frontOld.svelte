<script lang="ts">
  ...
  let tokenID: number = Number(props.tokenID);
  ...
  onMount(async () => {
    ...
    collection = await collectionGet(props.chainId, props.collection);
  });
</script>
  ...
  <main class="main-krd">
    <div id="kredeum-list">
      <section class="content">
        ...
        <!-- {#await tokenID then tokenID} -->
        <KredeumShortcodeView {collection} {tokenID} />
        <!-- {/await} -->
      </section>
    </div>
  </main>
